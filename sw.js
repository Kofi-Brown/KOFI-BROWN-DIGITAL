const CACHE='kbd-v6';
const ASSETS=['./','./index.html','./about.html','./services.html','./portfolio.html','./seasyn9.html','./pricing.html','./contact.html','./404.html','./styles.css','./script.js','./logo.svg','./logo.png','./manifest.webmanifest'];
